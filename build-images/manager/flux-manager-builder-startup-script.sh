...
sudo -u flux mv /tmp/system.toml /usr/local/etc/flux/system/conf.d/system.toml
...
sudo echo "/usr/local/etc/flux/imp *(rw,no_subtree_check,no_root_squash)" >> /etc/exports
sudo echo "/usr/local/etc/flux/security *(rw,no_subtree_check,no_root_squash)" >> /etc/exports
sudo echo "/usr/local/etc/flux/system *(rw,no_subtree_check,no_root_squash)" >> /etc/exports
sudo echo "/etc/munge *(rw,no_subtree_check,no_root_squash)" >> /etc/exports
